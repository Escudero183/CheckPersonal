 ...
 * 
 */
package com.app.checkpersonal.helper;
...
public class Thumbnailator {
	...
	public String upLoadFiles(String rootPath, String folder, MultipartFile file, String namefile, Boolean Thumb, String ThumbPosition) throws ApiCheckPersonalException {
        String ruta;
