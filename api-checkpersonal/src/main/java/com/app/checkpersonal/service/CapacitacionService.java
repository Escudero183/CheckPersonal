...
import com.app.checkpersonal.repository.CapacitacionRepository;
...
public class CapacitacionService {
	...
	public Capacitacion insert(Capacitacion item) {
		return capacitacionRepository.save(item);
	}
	
	public void update(Capacitacion item) {
		capacitacionRepository.save(item);
	}
	
	public void delete (Capacitacion item) {
		capacitacionRepository.save(item);		
	}
	...
	public List<Capacitacion> findAll(Integer idPersonal, String query, String sortBy) {
		Sort sort;
		if (!sortBy.equals("")) {
		...
		return capacitacionRepository.findAll(idPersonal, "%" + query.toLowerCase() + "%", sort);
	}
	...
	public HashMap<String, Object> findAll(Integer idPersonal, String query, int page, int limit, String sortBy) {
		...
		Page<Capacitacion> data = capacitacionRepository.findAllParams(idPersonal, "%" + query.toLowerCase() + "%", pageable);
